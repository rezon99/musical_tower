...
export function createDispenser(
  ...
  entity.addComponent(new GLTFShape('models/poap/poap_dispenser/POAP_dispenser.glb'))
  ...
  button.addComponent(new GLTFShape('models/poap/poap_button/POAP_button.glb'))
